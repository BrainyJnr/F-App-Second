...
import 'package:f/features/personalization/screens/profile/widgets/re_authenticate_user_login_form.dart';
...
class UserController extends GetxController {
  ...
  Future<void> reAuthenticateEmailAndPasswordUser() async {
    try {
      ...
      fFullScreenLoader.stopLoading();
      fLoaders.warningSnackBar(title: "Oh Snapyyyyyyyyyyyyyyyyyyy", message: e.toString());
    }
  }
