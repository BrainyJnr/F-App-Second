...
class fDummyData {
  static final List<CategoryModel> categories = [
    ...
    CategoryModel(
        ...
        isFeatured: true),
    CategoryModel(
        id: "3", name: "Clothes", image: fImages.clothIcon, isFeatured: true,),
    CategoryModel(
        id: "4", name: "Animals", image: fImages.animalIcon, isFeatured: true),
    CategoryModel(
        id: "6", name: "Shoes", image: fImages.shoeIcon, isFeatured: true),
    CategoryModel(
        id: "7",
        name: "Cosmetics",
  ...
  static final List<BannerModel> Banners = [
    ...
    BannerModel(
        ...
        active: true,
        targetScreen: fRoutes.favourites,
        isFeatured: false),
    BannerModel(
        name: "eio",
        id: "4",
        imageUrl: fImages.Banner4,
        active: true,
  ...
  static final List<BrandModel> Brands = [
    ...
    BrandModel(
        id: "2",
        image: fImages.Adidas,
        name: "Adidas",
        isFeatured: true,
        productsCount: 95),
    BrandModel(
        id: "3",
        image: fImages.Jordan,
        name: "Jordan",
        isFeatured: true,
        productsCount: 36),
    BrandModel(
    ...
    BrandModel(
        id: "9", image: fImages.appleLogo, name: "Apple", isFeatured: true),
    BrandModel(
        id: "10",
        image: fImages.Puma,
        name: "Nike",
    ...
    BrandModel(
        id: "13", image: fImages.Kenwood, name: "Kenwood", isFeatured: false),
  ];
